...
Do **not** use <kbd>file:</kbd> prefix in the Description if you want the image
...
[Link to <kbd>unicorn logo.png</kbd>](<../files-to-be-copied-to-static/foo/unicorn logo.png>)
